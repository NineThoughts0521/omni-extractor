...
class ExtractionResult(BaseModel):
    ...
    publish_time: Optional[str] = Field(None, description="Publication time if available")
    ...
    confidence: float = Field(ge=0.0, le=1.0, description="Confidence score of the extraction (0.0-1.0)")
...
class BatchResult(BaseModel):
    ...
    successes: List[ExtractionResult] = Field(description="List of successful extractions")
